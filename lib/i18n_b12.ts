...
const B12: Record<string, string> = {
  ...
  "Saat-/Pflanzgut, D\u00fcnger, Pflanzenschutz, Material, Handarbeit und Maschinen-Betrieb (inkl. Diesel), dazu aktive Lohnarbeit. OHNE Abschreibung, Zins, Pacht, Personal und Overhead \u2014 das sind Strukturkosten. \u20ac/t bezieht sich auf die NETTO-Menge nach Ernteverlust, ist also direkt mit dem Kontraktpreis vergleichbar.": "Seed/planting material, fertiliser, crop protection, materials, hand labour and machine operating cost (incl. diesel), plus active contract work. EXCLUDING depreciation, interest, rent, staff and overhead \u2014 those are structural costs. \u20ac/t refers to the NET quantity after harvest loss, so it compares directly with the contract price.",
