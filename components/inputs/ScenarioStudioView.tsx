...
const DRIVERS: Drv[] = [
  ...
  { id: "store.months", label: "Lagerdauer Ø (Monate)", group: G_PRC, keys: ["store.months"], mode: "abs", unit: "Mon.", min: 0, max: 9, step: 1, dec: 0 },
  { id: "quality.reject", label: "Zurückweisungsquote am Werkstor", hint: "Erlösabschlag; die Kosten bleiben, die Ware ist gewachsen", group: G_PRC, keys: ["quality.reject"], mode: "abs", unit: "%", min: 0, max: 15, step: 0.5, dec: 1 },
  { id: "market.cover_premium", label: "Deckungskauf-Aufschlag je t Fehlmenge", hint: "greift erst, wenn die Ernte unter die kontrahierte Menge fällt", group: G_PRC, keys: ["market.cover_premium"], mode: "abs", unit: "€/t", min: 0, max: 200, step: 5, dec: 0 },
